describe({
    ...
    t.chain(
        ...
        {
            type: ".g-text g-text_variant_header-1 base-admin__title:textEquals(Роли)", desc: "Раздел доступен"
        },
        ...
        {
            type: ".dl-collections-navigation-layout__header-title:textEquals(Роли)", desc: "Раздел  недоступен"
        },
